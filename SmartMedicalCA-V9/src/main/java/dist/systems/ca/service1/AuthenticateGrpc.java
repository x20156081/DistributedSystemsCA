...
public final class AuthenticateGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckInRequest,
      dist.systems.ca.service1.CheckInReply> getCheckInMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckIn",
      requestType = dist.systems.ca.service1.CheckInRequest.class,
      responseType = dist.systems.ca.service1.CheckInReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckInRequest,
      dist.systems.ca.service1.CheckInReply> getCheckInMethod() {
    io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckInRequest, dist.systems.ca.service1.CheckInReply> getCheckInMethod;
      ...
      synchronized (AuthenticateGrpc.class) {
        if ((getCheckInMethod = AuthenticateGrpc.getCheckInMethod) == null) {
          AuthenticateGrpc.getCheckInMethod = getCheckInMethod = 
              io.grpc.MethodDescriptor.<dist.systems.ca.service1.CheckInRequest, dist.systems.ca.service1.CheckInReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Authenticate", "CheckIn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dist.systems.ca.service1.CheckInRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dist.systems.ca.service1.CheckInReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckOutRequest,
      dist.systems.ca.service1.CheckOutReply> getCheckOutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckOut",
      requestType = dist.systems.ca.service1.CheckOutRequest.class,
      responseType = dist.systems.ca.service1.CheckOutReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckOutRequest,
      dist.systems.ca.service1.CheckOutReply> getCheckOutMethod() {
    io.grpc.MethodDescriptor<dist.systems.ca.service1.CheckOutRequest, dist.systems.ca.service1.CheckOutReply> getCheckOutMethod;
    if ((getCheckOutMethod = AuthenticateGrpc.getCheckOutMethod) == null) {
      synchronized (AuthenticateGrpc.class) {
        if ((getCheckOutMethod = AuthenticateGrpc.getCheckOutMethod) == null) {
          AuthenticateGrpc.getCheckOutMethod = getCheckOutMethod = 
              io.grpc.MethodDescriptor.<dist.systems.ca.service1.CheckOutRequest, dist.systems.ca.service1.CheckOutReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Authenticate", "CheckOut"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dist.systems.ca.service1.CheckOutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dist.systems.ca.service1.CheckOutReply.getDefaultInstance()))
  ...
  public static abstract class AuthenticateImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void checkIn(dist.systems.ca.service1.CheckInRequest request,
        io.grpc.stub.StreamObserver<dist.systems.ca.service1.CheckInReply> responseObserver) {
      asyncUnimplementedUnaryCall(getCheckInMethod(), responseObserver);
    }

    /**
     */
    public void checkOut(dist.systems.ca.service1.CheckOutRequest request,
        io.grpc.stub.StreamObserver<dist.systems.ca.service1.CheckOutReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                dist.systems.ca.service1.CheckOutRequest,
                dist.systems.ca.service1.CheckOutReply>(
  ...
  public static final class AuthenticateBlockingStub extends io.grpc.stub.AbstractStub<AuthenticateBlockingStub> {
    ...
    /**
     */
    public dist.systems.ca.service1.CheckInReply checkIn(dist.systems.ca.service1.CheckInRequest request) {
    ...
    /**
     */
    public dist.systems.ca.service1.CheckOutReply checkOut(dist.systems.ca.service1.CheckOutRequest request) {
      return blockingUnaryCall(
  ...
  public static final class AuthenticateFutureStub extends io.grpc.stub.AbstractStub<AuthenticateFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<dist.systems.ca.service1.CheckInReply> checkIn(
        dist.systems.ca.service1.CheckInRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<dist.systems.ca.service1.CheckOutReply> checkOut(
        dist.systems.ca.service1.CheckOutRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_IN:
          serviceImpl.checkIn((dist.systems.ca.service1.CheckInRequest) request,
              (io.grpc.stub.StreamObserver<dist.systems.ca.service1.CheckInReply>) responseObserver);
          break;
        case METHODID_CHECK_OUT:
          serviceImpl.checkOut((dist.systems.ca.service1.CheckOutRequest) request,
              (io.grpc.stub.StreamObserver<dist.systems.ca.service1.CheckOutReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthenticateBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dist.systems.ca.service1.SmartMedAuthenticate.getDescriptor();
    }
