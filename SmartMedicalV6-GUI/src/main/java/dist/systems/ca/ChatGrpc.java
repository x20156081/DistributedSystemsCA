...
public final class ChatGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dist.systems.ca.chatMsg,
      dist.systems.ca.chatMsg> getChatBiDiMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ChatBiDi",
      requestType = dist.systems.ca.chatMsg.class,
      responseType = dist.systems.ca.chatMsg.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<dist.systems.ca.chatMsg,
      dist.systems.ca.chatMsg> getChatBiDiMethod() {
    io.grpc.MethodDescriptor<dist.systems.ca.chatMsg, dist.systems.ca.chatMsg> getChatBiDiMethod;
      ...
      synchronized (ChatGrpc.class) {
        if ((getChatBiDiMethod = ChatGrpc.getChatBiDiMethod) == null) {
          ChatGrpc.getChatBiDiMethod = getChatBiDiMethod = 
              io.grpc.MethodDescriptor.<dist.systems.ca.chatMsg, dist.systems.ca.chatMsg>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Chat", "ChatBiDi"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dist.systems.ca.chatMsg.getDefaultInstance()))
  ...
  public static abstract class ChatImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<dist.systems.ca.chatMsg> chatBiDi(
        io.grpc.stub.StreamObserver<dist.systems.ca.chatMsg> responseObserver) {
  ...
  private static abstract class ChatBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dist.systems.ca.SmartMedChat.getDescriptor();
    }
